...
export const TURTLE_SHEETS_FORM_FIELDS: TurtleFormFieldConfig[] = [
  ...
  { key: 'freq', label: 'Freq', placeholder: 'Frequency', type: 'text', span: { base: 12, md: 6 } },
  ...
  { key: 'plastron_picture_in_archive', label: 'Plastron Picture in Archive?', placeholder: 'Yes/No', type: 'select', selectData: ['Yes', 'No'], span: { base: 12, md: 3 } },
  { key: 'carapace_picture_in_archive', label: 'Carapace Picture in Archive?', placeholder: 'Yes/No', type: 'select', selectData: ['Yes', 'No'], span: { base: 12, md: 3 } },
