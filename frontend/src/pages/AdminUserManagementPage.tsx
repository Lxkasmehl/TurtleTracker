...
import { IconMail, IconShield, IconAlertCircle, IconCheck, IconUsers } from '@tabler/icons-react';
import { useUser } from '../hooks/useUser';
import { useNavigate } from 'react-router-dom';
import { promoteToAdmin, getUsers, setUserRole } from '../services/api';
      ...
      <Stack gap='lg'>
        ...
        <Paper shadow='sm' p={{ base: 'md', sm: 'xl' }} radius='md' withBorder>
          ...
          <Text size='sm' c='dimmed' mt='xs' mb='md'>
            ...
            management), Admin (full access including this page).
          </Text>
          {usersLoading ? (
            <Center py='xl'>
              <Loader size='lg' />
                ...
                <Stack key={roleKey} gap='xs'>
                  ...
                  {list.length === 0 ? (
                    ...
                    <Table striped highlightOnHover style={{ tableLayout: 'fixed' }}>
                      <Table.Thead>
                        <Table.Tr>
                          <Table.Th style={{ width: '40%' }}>Email</Table.Th>
